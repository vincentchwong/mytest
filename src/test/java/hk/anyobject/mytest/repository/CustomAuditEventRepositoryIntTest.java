package hk.anyobject.mytest.repository;

import hk.anyobject.mytest.MytestApp;
import hk.anyobject.mytest.config.Constants;
import hk.anyobject.mytest.config.audit.AuditEventConverter;
import hk.anyobject.mytest.domain.PersistentAuditEvent;
...
import static hk.anyobject.mytest.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
